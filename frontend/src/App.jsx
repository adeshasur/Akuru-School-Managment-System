          ...
          <form className="space-y-6">
            ...
            <div className="pt-4">
              <motion.button 
                ...
                whileTap={{ scale: 0.98 }}
                className="w-full bg-blue-600 text-white font-bold py-4 rounded-2xl shadow-[0_10px_20px_-10px_rgba(37,99,235,0.4)] transition-all hover:bg-blue-700 text-lg"
              >
                Login
              </motion.button>
            </div>
